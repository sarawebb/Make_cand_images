...
path = '/fred/oz100/swebb/make_cand_images/candidates/cand_'+objid+'_'+field+'/'
...
for i in range(len(path2_insidefield)):
    ...
    ds9string1=ds9string+path2_insidefield[i]+' -crosshair '+str(ra)+' '+str(dec)+' wcs fk5 -pan to '+str(ra)+' '+str(dec)+' wcs fk5 -saveimage jpeg ' + path + field+'_'+ format(i, '03')+'.jpeg -exit'
    os.system(ds9string1)
