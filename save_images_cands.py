...
for i in range(len(path2_insidefield)):
    ...
    ds9string1=ds9string+path2_insidefield[i]+' -pan to '+str(ra)+' '+str(dec)+' wcs fk5 -saveimage /fred/oz100/swebb/open_cands/TEST_images/'+field+'_cand_ID_'+str(objid)+'_'+format(i, '03')+'.jpeg -exit '
